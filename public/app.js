    ...
    try {
        ...
        $('#tblFixture tbody tr').each((i, row) => {
            if ($(row).hasClass('competition')) {
                ...
                if (homeLink) global.allTeamLinks.set(homeTeam, `https://arsiv.mackolik.com${homeLink}`);
                if (awayLink) global.allTeamLinks.set(awayTeam, `https://arsiv.mackolik.com${awayLink}`);
